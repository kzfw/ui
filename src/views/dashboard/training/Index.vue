	...
	<div class="card">
		<div class="training-request">
			<div class="row row_no_margin">
				<div class="card-title col s8"><span class="card-title">Initial Training Request</span></div>
				<div class="col s4"><router-link to="/dash/training/initial"><span class="btn new_event_button right">Request</span></router-link></div>
			</div>
		</div>
		...
		<p class="no_sessions" v-else-if="upcomingSessions && upcomingSessions.length === 0">You have not requested training. Please use the button above to request training. You must do this in order to begin your training at ZFW.</p>
