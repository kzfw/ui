      ...
      <table class="striped">
        ...
        <tbody class="certs_list_row">
          <tr v-for="app in applications" :key="app.cid">
            ...
            <td>{{ app.home }}</td>
            <td class="options">
              <a :href="`#modal_${app.cid}`" class="modal-trigger"
            ...
            <div :id="`modal_${app.cid}`" class="modal modal_visit">
              ...
              <div class="modal-footer">
                ...
                <a
                  ...
                  @click="openRejectModal(app.cid)"
                  >Reject</a
                >
                <a
                  href="#!"
                  class="waves-effect waves-light btn right"
                  @click="approveVisitor(app.cid)"
                  >Approve</a
                >
              </div>
            </div>
              ...
              <div class="modal-content">
                ...
                <div class="row row_no_margin">
                  <div class="input-field col s12">
                    ...
                    />
                    <label :for="`reason_${app.cid}`" class="active"
                      >Reason</label
                    >
                  </div>
                </div>
